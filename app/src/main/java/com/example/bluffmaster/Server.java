...
public class Server extends AppCompatActivity {
    ...
    ArrayList<com.example.bluffmaster.Message> messages = new ArrayList<>();
    ...
    public void sendServerMessage(View view) {
        ...
        if(msg.length() > 0) {
            ...
            com.example.bluffmaster.Message serverMessage = new com.example.bluffmaster.Message(msg, true, timeStamp);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            String timeStamp = new SimpleDateFormat("HH:mm").format(Calendar.getInstance().getTime());
            com.example.bluffmaster.Message recvMessage = new com.example.bluffmaster.Message(new_msg, false, timeStamp);
